...
void argos::CQTOpenGLLuaEditor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CQTOpenGLLuaEditor *_t = static_cast<CQTOpenGLLuaEditor *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject argos::CQTOpenGLLuaEditor::staticMetaObject = {
    { &QPlainTextEdit::staticMetaObject, qt_meta_stringdata_argos__CQTOpenGLLuaEditor.data,
      qt_meta_data_argos__CQTOpenGLLuaEditor,  qt_static_metacall, nullptr, nullptr}
};
